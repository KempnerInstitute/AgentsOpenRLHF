"""
llama_frozenlake_model_eval.py
...
def main():
    ...
    parser.add_argument("--finetuned-model", default="./openrlhf_artifacts/sft_llama8", help="Fine-tuned model path")
    ...
    try:
        from scripts.llama_fl_evaluator import FrozenLakeEvaluator
    except ImportError:
