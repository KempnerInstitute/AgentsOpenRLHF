...
from scripts.fl_eval_strict import FrozenLakeEvaluatorStrict
...
class FrozenLakeAgentInstance(AgentInstanceBase):
    ...
    def _parse_full_trajectory(self, response: str) -> tuple:
        ...
        multistep_eval = FrozenLakeEvaluatorStrict()
    ...
    async def step(self, observation, action, label, **kwargs) -> Dict[str, Any]:
        ...
        if self.interactive:
            ...
            if goal is True:
                ...
                # with open("/n/holylfs06/LABS/kempner_undergrads/Lab/ellenma/openrlhf-proj/AgentsOpenRLHF/rl_run_logs/017_successful.jsonl", "a") as f:
